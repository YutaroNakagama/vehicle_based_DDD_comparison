...
# ============================================================
# Re-evaluation Script for split2 domain experiments
# ============================================================
# Runs evaluation only (no training) with fixed --target_file
# and --seed to correct Bug #1 (missing target_file in eval).
#
...
echo "============================================================"
echo "[RE-EVAL - SPLIT2] ${CONDITION^^} / ${MODE}"
echo "============================================================"
