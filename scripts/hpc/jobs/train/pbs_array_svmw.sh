...
# ============================================================
# PBS Array Job: SvmW (unified: domain_train + within/cross eval)
# ============================================================
# Each array element picks one task line from TASK_FILE
# using $PBS_ARRAY_INDEX as the 0-based line index.
#
# Submit: qsub -J 0-367 -q SINGLE \
#           -v TASK_FILE=scripts/hpc/logs/train/task_files/array_svmw_tasks.txt \
#           scripts/hpc/jobs/train/pbs_array_svmw.sh
# ============================================================
set -uo pipefail
