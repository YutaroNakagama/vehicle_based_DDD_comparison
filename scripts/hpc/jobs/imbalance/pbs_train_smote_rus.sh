...
# ============================================================
# Imbalance Comparison V2: SMOTE + RandomUnderSampler
# Hybrid approach: oversample + undersample for optimal balance
# ============================================================
set -euo pipefail
...
MODEL="${MODEL:-RF}"
SEED="${SEED:-42}"
TAG="imbal_v2_smote_rus_seed${SEED}"

echo "============================================================"
echo "[IMBALANCE COMPARISON V2] SMOTE + RandomUnderSampler"
echo "============================================================"
echo "MODEL: $MODEL"
echo "SEED: $SEED"
echo "TAG: $TAG"
echo "MODE: pooled"
echo "OVERSAMPLING: SMOTE + RUS (hybrid)"
echo "N_TRIALS: 50"
echo "CV_FOLDS: 5"
...
python scripts/python/train/train.py \
    ...
    --use_oversampling \
    --oversample_method smote_rus \
    --tag "$TAG"

echo "=== SMOTE+RUS TRAINING DONE ==="
