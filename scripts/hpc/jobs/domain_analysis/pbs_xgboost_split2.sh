...
# ============================================================
# XGBoost Validation — Domain Analysis (2-group split)
# ============================================================
# Replicates the RF factorial experiment with XGBoost to validate
# that Sobol-Hoeffding variance decomposition results are
# classifier-independent (A1 validation).
#
...
# Generate tag (xgb_ prefix to distinguish from RF results)
case "$CONDITION" in
    baseline)
...
echo "============================================================"
echo "[XGBOOST VALIDATION — SPLIT2] ${CONDITION^^}"
echo "============================================================"
echo "MODEL: $MODEL"
...
echo ""
echo "[DONE] XGBoost validation job completed successfully"
echo "============================================================"
