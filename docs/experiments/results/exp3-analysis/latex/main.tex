...
Independent local verification on the SW-SMOTE mmd in-domain subset ($N{=}20$ within evaluations: 12 seeds at $r{=}0.3$ and 8 seeds at $r{=}0.5$, retrained on RTX~3060 with cuML 25.12 GPU-accelerated SVC, kernel cache 4096~MiB) yields AUROC $= 0.486 \pm 0.007$ ($r{=}0.3$) and $0.479 \pm 0.006$ ($r{=}0.5$); the corresponding cross-domain evaluations yield AUROC $= 0.497 \pm 0.022$ and $0.495 \pm 0.018$.
