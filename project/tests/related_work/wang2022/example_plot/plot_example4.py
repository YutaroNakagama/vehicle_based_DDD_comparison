...
ax5.set_ylabel('Speed (m/s)', fontsize=font_size, color='blue')
ax6.set_ylabel('Acceleration (m/s²)', fontsize=font_size, color='red')
ax5.legend(loc='upper left', fontsize=font_size)
ax6.legend(loc='upper right', fontsize=font_size)
...
ax7.set_ylabel('Lane Offset (cm)', fontsize=font_size, color='cyan')
ax8.set_ylabel('Steering Rate (degrees/s)', fontsize=font_size, color='magenta')
ax7.legend(loc='upper left', fontsize=font_size)
ax8.legend(loc='upper right', fontsize=font_size)
...
ax1.set_ylabel('Speed (m/s)', fontsize=font_size, color='blue')
ax2.set_ylabel('Acceleration (m/s²)', fontsize=font_size, color='orange')
...
ax3.set_ylabel('Lane Offset (cm)', fontsize=font_size, color='red')
ax4.set_ylabel('Steering Rate (deg/s)', fontsize=font_size, color='purple')
