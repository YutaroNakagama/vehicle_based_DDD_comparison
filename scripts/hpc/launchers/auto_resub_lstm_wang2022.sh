#!/bin/bash
# ============================================================
# LSTM Wang2022 auto-submit script
# ============================================================
# Read unsubmitted Lstm jobs from /tmp/remaining_lstm_wang2022.txt,
...
#
# Usage:
#   nohup bash scripts/hpc/launchers/auto_resub_lstm_wang2022.sh &
# ============================================================
...
REMAINING_FILE="/tmp/remaining_lstm_wang2022.txt"
RANKING="knn"
...
mkdir -p "$LOG_DIR"
LOG_FILE="$LOG_DIR/auto_resub_lstm_wang2022_${TIMESTAMP}.log"

echo "============================================================"
echo "LSTM Wang2022 auto-submit started: $(date)"
echo "remainingjob(s): $(wc -l < "$REMAINING_FILE") items"
echo "Retry interval: ${SLEEP_INTERVAL}s"
echo "Log: $LOG_FILE"
echo "============================================================"

echo "# LSTM Wang2022 auto resub started at $(date)" > "$LOG_FILE"
...
{
    echo ""
    echo "# LSTM Wang2022 auto resub completed at $(date)"
...
echo ""
echo "============================================================"
echo "LSTM Wang2022 auto-submission complete: $(date)"
