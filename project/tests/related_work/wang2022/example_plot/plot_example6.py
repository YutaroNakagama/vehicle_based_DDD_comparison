...
legend1 = ax5.legend(lines5 + lines6, labels5 + labels6, loc='lower right', fontsize=font_size, fancybox=False, framealpha=1, edgecolor='black')
...
ax5.text(2, 14, 'Baseline $i_1$', fontsize=font_size, ha='center', va='bottom')
ax5.text(5.75, 14, 'Event $i$', fontsize=font_size, ha='center', va='bottom')
ax5.text(8.5, 14, 'Baseline $i_2$', fontsize=font_size, ha='center', va='bottom')
...
ax2.plot(lsl_time[mask_sim], smoothed_longitudinal_acc_sim[mask_sim], label='Longitudinal Acceleration (m/s²)', color='red', zorder=5)
...
legend3 = ax1.legend(lines1 + lines2, labels1 + labels2, loc='lower left', fontsize=font_size, fancybox=False, framealpha=1, edgecolor='black')
legend3.set_zorder(10)
#ax1.grid(True)

# Add text annotations
#ax1.set_ylim([0,14])
y_pos = 29.28 #max(smoothed_velocity_sim[adjusted_mask_sim]) * 1.1 
ax1.text(drt_start_time-1.5, y_pos, 'Baseline $i_1$', fontsize=font_size, ha='center', va='bottom')
ax1.text((drt_start_time+drt_end_time)/2, y_pos, 'Event $i$', fontsize=font_size, ha='center', va='bottom')
ax1.text(drt_end_time+0.7, y_pos, 'Baseline $i_2$', fontsize=font_size, ha='center', va='bottom')
