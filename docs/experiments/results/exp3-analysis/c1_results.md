...
> **最終更新: 2026-07-24**（**c1 グリッド全完了**: RF/SvmW/SvmA/Lstm・iv25 baseline・RF-nofs 全完走、SvmW 32/32、全 eval 異常なし＝ verification_log 2026-07-24 節）。**方針決定（ユーザ 07-20）**: exp3 は **IV2025/TIV2026 と同一方法論で完遂**し
...
8/8 シード**完走**（全条件 chance 帯で確定）。**SvmW も 32/32 完走**（Within 8/8・Mixed 8/8、Cross 2/8 demoted）。
**[2026-07-24 完了] c1 グリッド全手法・全 iv25 ベースライン・RF-nofs 完走**（watchdog も 07-23 12:18 "ALL COMPLETE" で自己終了）。異常終了ゼロ・全値想定帯内。）
