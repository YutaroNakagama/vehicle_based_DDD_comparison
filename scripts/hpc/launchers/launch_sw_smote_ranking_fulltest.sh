#!/bin/bash
# ============================================================
# Subject-wise SMOTE + Ranking Methods Full Test
# ============================================================
...
JOB_LOG="${PROJECT_ROOT}/scripts/hpc/logs/imbalance/job_ids_sw_smote_fulltest_${TIMESTAMP}.txt"

echo "============================================================"
echo "Subject-wise SMOTE + Ranking Full Test"
echo "============================================================"
...
# Initialize job log
echo "# Subject-wise SMOTE Full Test: $TIMESTAMP" > "$JOB_LOG"
        ...
        for DISTANCE in $DISTANCES; do
            for DOMAIN in $DOMAINS; do
                for MODE in $MODES; do
                    ...
                    # Submit job
                    JOB=$(qsub -N "sw_${RATIO_STR}_${RANKING:0:2}_${DISTANCE:0:1}_${DOMAIN:0:3}_${MODE:0:3}" \
                        -q "$QUEUE" \
