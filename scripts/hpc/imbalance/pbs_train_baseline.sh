...
# ============================================================
# Imbalance Comparison V2: Baseline (No Oversampling)
# Improved conditions:
#   - N_TRIALS=100
#   - CV=5-fold
#   - Objective=F2 score
...
# --- Improved experiment conditions ---
...
MODEL="${MODEL:-RF}"
SEED="${SEED:-42}"
TAG="imbal_v2_baseline_seed${SEED}"

echo "============================================================"
echo "[IMBALANCE COMPARISON V2] Baseline (No Oversampling)"
echo "============================================================"
echo "MODEL: $MODEL"
echo "SEED: $SEED"
echo "TAG: $TAG"
echo "MODE: pooled"
echo "OVERSAMPLING: None (baseline)"
echo "N_TRIALS: 50"
echo "CV_FOLDS: 5"
