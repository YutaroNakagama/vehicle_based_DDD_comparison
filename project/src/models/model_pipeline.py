...
from src.models.anfis import calculate_id
...
def optimizar(name,clf):
    ...
    optimized_params, best_score = pso(objective_function_with_progress, lb, ub, swarmsize=20, maxiter=10, debug=True)
