...
\begin{figure}[t]
        \centerline{\includegraphics[width=0.5\textwidth, trim=0 5 0 0, clip]{fig/wang_sample.pdf}}
...
\begin{figure}[t]
\centerline{\includegraphics[width=0.5\textwidth]{fig/roc_em.pdf}}
    \caption{ROC curves.}
    \label{roc}
\end{figure} 
...
\Ishii{This work was supported by JST, CREST Grant Number JPMJCR23M1, and JSPS, KAKENHI Grant Number 23K11969.}
