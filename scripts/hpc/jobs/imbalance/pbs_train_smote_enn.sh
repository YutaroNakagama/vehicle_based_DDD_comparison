...
# ============================================================
# Imbalance Comparison V2: SMOTE + ENN
# ============================================================
set -euo pipefail
...
echo "============================================================"
echo "[IMBALANCE COMPARISON V2] SMOTE + ENN"
echo "============================================================"
echo "MODEL: $MODEL"
echo "MODE: pooled"
echo "OVERSAMPLING: SMOTE + ENN"
echo "N_TRIALS: 100"
echo "CV_FOLDS: 5"
...
python scripts/python/train.py \
    ...
    --use_oversampling \
    --oversample_method smote_enn \
    --tag "imbal_v2_smote_enn"

echo "=== SMOTE+ENN TRAINING DONE ==="
