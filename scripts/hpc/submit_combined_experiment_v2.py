#!/usr/bin/env python3
"""
Combined Experiment V2: Imbalance + Ranking (Memory Optimized)
不均衡対策 + ランキングベース被験者選択の組み合わせ実験

Memory Optimization (based on V1 analysis):
- Training: 16gb → 4gb (actual usage: ~2.5gb max)
- Evaluation: 8gb → 4gb (actual usage: ~1gb max)
...
LOG_DIR = PROJECT_ROOT / "logs" / "combined_v2"
