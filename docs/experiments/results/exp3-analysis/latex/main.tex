...
\begin{figure}[!t]
\centering
\todo{generate: bar chart with four method groups (RF, Lstm, SvmW, SvmA), three bars per group (F2, AUROC, AUPRC), each method at its best-rebalancing condition; annotate Lstm F2 as ``positive-class bias'' and SvmA AUROC with ``degenerate''}
