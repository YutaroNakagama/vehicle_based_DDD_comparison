#!/bin/bash
# ============================================================
# SvmW Zhao2009 auto-submit script
# ============================================================
# Read unsubmitted SvmW jobs from /tmp/remaining_svmw_zhao2009.txt,
...
#
# Usage:
#   nohup bash scripts/hpc/launchers/auto_resub_svmw_zhao2009.sh &
# ============================================================
...
REMAINING_FILE="/tmp/remaining_svmw_zhao2009.txt"
RANKING="knn"
...
mkdir -p "$LOG_DIR"
LOG_FILE="$LOG_DIR/auto_resub_svmw_zhao2009_${TIMESTAMP}.log"

echo "============================================================"
echo "SvmW Zhao2009 auto-submit started: $(date)"
echo "remainingjob(s): $(wc -l < "$REMAINING_FILE") items"
echo "Retry interval: ${SLEEP_INTERVAL}s"
echo "Log: $LOG_FILE"
echo "============================================================"

echo "# SvmW Zhao2009 auto resub started at $(date)" > "$LOG_FILE"
...
{
    echo ""
    echo "# SvmW Zhao2009 auto resub completed at $(date)"
...
echo ""
echo "============================================================"
echo "SvmW Zhao2009 auto-submission complete: $(date)"
