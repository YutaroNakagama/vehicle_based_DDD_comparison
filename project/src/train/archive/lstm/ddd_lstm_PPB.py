...
if __name__ == '__main__':
    ...
    epochs = 200 
    batch_size = 8
    test_size = 0.20 # % of test datasets (train_val (1-size) vs. test (size))
    vali_size = 0.25 # % of vali datasets (train (1-size) vs. vali (size))
    ...
    #train_normal.train(awake_train_inputs, awake_train_labels, awake_train_inputs, awake_train_labels,\
                epochs, batch_size, sequence_length, input_size, plot=True)
    #train_abnormal.train(drow_train_inputs, drow_train_labels, drow_train_inputs, drow_train_labels,\
    ...
    print("awake  (normal):   ", len(awake_train_labels))
    print("drowsy (abnormal): ", len(drow_train_labels))
    print("number of normal/abnormal datasets for vali")
    print("awake  (normal):   ", len(awake_vali_labels))
    print("drowsy (abnormal): ", len(drow_vali_labels))
    ...
    print("awake")
    #epsss_ave_awake_normal = train_normal.pred_result(awake_train_inputs, awake_train_labels, awake_train_times,\
    ...
    #epsss_ave_awake_normal = train_normal.pred_result(awake_train_inputs, awake_train_labels, awake_train_times,\
    #                                    awake_train_cnt, sequence_length, input_size, plot=True, sample_type="full")
    #epsss_ave_awake_abnormal = train_abnormal.pred_result(awake_train_inputs, awake_train_labels, awake_train_times,\
    #                                    awake_train_cnt, sequence_length, input_size, plot=True, sample_type="full")
