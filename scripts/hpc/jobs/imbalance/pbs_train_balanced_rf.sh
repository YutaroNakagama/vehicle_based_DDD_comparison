...
# ============================================================
# Imbalance Comparison V2: BalancedRandomForest
# (No oversampling needed - handles imbalance internally)
# ============================================================
set -euo pipefail
...
echo "============================================================"
echo "[IMBALANCE COMPARISON V2] BalancedRandomForest"
echo "============================================================"
echo "MODEL: BalancedRF"
echo "MODE: pooled"
echo "OVERSAMPLING: None (handled internally by BalancedRF)"
echo "SEED: $SEED"
echo "TAG: $TAG"
echo "N_TRIALS: 100"
echo "CV_FOLDS: 5"
...
echo "=== BALANCED RF TRAINING DONE ==="
