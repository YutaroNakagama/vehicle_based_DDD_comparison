...
# ===== settings =====
RANK_NAMES_FILE="${RANK_NAMES_FILE:-$PROJECT_ROOT/misc/rank_names_10_was.txt}"
SEED="${SEED:-42}"
MODEL="${MODEL:-RF}"

# 実行順序：必要に応じて変更
RUN_ORDER=("only_target")
...
# ===== finetune 用の pretrain 設定 =====
PRESET_DIR="$PROJECT_ROOT/model/common_k10"
mkdir -p "$PRESET_DIR"
