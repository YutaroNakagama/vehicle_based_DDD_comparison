...
file_paths = {
    ...
    "SvmA": "roc_val_aref.csv",
    "SvmW": "roc_time_window_zhao.csv",
    "Lstm": "roc_data_52_wang.csv",
...
plt.rcParams.update({'font.family': 'Times New Roman', 'font.size': 17})  # Set font to Times New Roman and size to 10
