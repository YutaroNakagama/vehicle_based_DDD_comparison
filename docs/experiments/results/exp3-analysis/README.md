...
| [local_execution.md](local_execution.md) | **Local-PC runs (Phase 1–5, 2026-05-16 → in flight)** — Phase 1: 108-job CPU subset (SvmW + SvmA + Lstm, 3 seeds) via [`local_exp3_launcher.py`](../../../../scripts/python/train/local_exp3_launcher.py). Phase 2: WSL2/CUDA Lstm SW-SMOTE 15-seed expansion (180 jobs) via [`local_exp3_lstm_wsl2_launcher.py`](../../../../scripts/python/train/local_exp3_lstm_wsl2_launcher.py). Phase 3: WSL2/CUDA Lstm non-SW-SMOTE expansion (270 jobs) via [`local_exp3_lstm_wsl2_other_launcher.py`](../../../../scripts/python/train/local_exp3_lstm_wsl2_other_launcher.py). Phase 4: SvmW Phase 2 (108) via [`local_exp3_svmw_phase2_launcher.py`](../../../../scripts/python/train/local_exp3_svmw_phase2_launcher.py) **complete**, SvmA Phase 2 (108) via [`local_exp3_svma_phase2_launcher.py`](../../../../scripts/python/train/local_exp3_svma_phase2_launcher.py) **terminated by 2026-05-22 reboot**. Phase 5: post-reboot SvmA 20-worker relaunch (2026-05-23 11:03), 0 / 36 DONE at 2026-05-24 20:43 (PSO body silent, workers healthy at ~27.7 h CPU / 33.7 h wall). |
